...
static void sCreateUI(GLFWwindow* window)
{
    ...
    CFURLRef fontURL = CFBundleCopyResourceURL(mainBundle, CFSTR("Data/DroidSans"), CFSTR("ttf"), NULL);
    CFStringRef fontRPath = CFURLCopyFileSystemPath(fontURL, kCFURLPOSIXPathStyle);
    CFStringEncoding encodingMethod = CFStringGetSystemEncoding();
    fontPath = CFStringGetCStringPtr(fontRPath, encodingMethod);
#endif
